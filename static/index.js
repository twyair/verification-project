...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html, body {\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    height: 100%;\n}\n\n* {\n    box-sizing: border-box;\n}\n\n#ide {\n    display: flex;\n    width: 100%;\n    height: 100%;\n}\n\n#ide > div {\n    border-right: 1px solid #ccc;\n}\n\n#ide > #panel-benchmarks ul {\n    list-style: none;\n    padding-inline-start: 0;\n}\n\n#ide > #panel-benchmarks li::before {\n    content: \"‣ \";\n}\n\n#ide > #panel-editor {\n    flex-grow: 1;\n    padding: 0;\n    width: 47vw;\n    height: 95vh;\n}\n\n#panel-editor .CodeMirror {\n    height: 100%;\n    background: #eee;\n}\n\n#panel-output {\n    padding-left: 2vw;\n    width: 47vw;\n    height: 95vh;\n    float: right;\n    overflow: scroll;\n}\n\n#panel-output #output {\n    font-family: Courier, monospace;\n    white-space: pre;\n}\n\n.highlight-code {\n    background-color: yellow;\n}", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,gBAAgB;IAChB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,UAAU;IACV,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,iBAAiB;IACjB,WAAW;IACX,YAAY;IACZ,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,+BAA+B;IAC/B,gBAAgB;AACpB;;AAEA;IACI,wBAAwB;AAC5B","sourcesContent":["html, body {\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    height: 100%;\n}\n\n* {\n    box-sizing: border-box;\n}\n\n#ide {\n    display: flex;\n    width: 100%;\n    height: 100%;\n}\n\n#ide > div {\n    border-right: 1px solid #ccc;\n}\n\n#ide > #panel-benchmarks ul {\n    list-style: none;\n    padding-inline-start: 0;\n}\n\n#ide > #panel-benchmarks li::before {\n    content: \"‣ \";\n}\n\n#ide > #panel-editor {\n    flex-grow: 1;\n    padding: 0;\n    width: 47vw;\n    height: 95vh;\n}\n\n#panel-editor .CodeMirror {\n    height: 100%;\n    background: #eee;\n}\n\n#panel-output {\n    padding-left: 2vw;\n    width: 47vw;\n    height: 95vh;\n    float: right;\n    overflow: scroll;\n}\n\n#panel-output #output {\n    font-family: Courier, monospace;\n    white-space: pre;\n}\n\n.highlight-code {\n    background-color: yellow;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var codemirror_mode_clike_clike_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! codemirror/mode/clike/clike.js */ "./node_modules/codemirror/mode/clike/clike.js");
/* harmony import */ var codemirror_mode_clike_clike_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_clike_clike_js__WEBPACK_IMPORTED_MODULE_2__);
...
class IDE {
    constructor() {
        ...
        this.cm = codemirror__WEBPACK_IMPORTED_MODULE_0___default()(this.panels.editor, {
            lineNumbers: true,
            //matchBrackets: true,
            mode: "text/x-csrc",
            indentUnit: 4,
...
int array_max_bug(int arr[], int size) {
    ...
    async open(uri) {
        var text = await (await fetch(uri)).text(), doc = new (codemirror__WEBPACK_IMPORTED_MODULE_0___default().Doc)(text, "text/x-csrc");
        this.cm.swapDoc(doc);
    }
    async runVerifier() {
    ...
    show_path(index) {
        ...
        for (const range of this.paths[index].ranges) {
            this.cm.markText({ line: range.start_line - 1, ch: range.start_column - 1 }, { line: range.end_line - 1, ch: range.end_column - 1 }, {
